...
describe('ThemeSwitcher', () => {
  ...
  it('should render toggle checkbox and icons', () => {
    ...
    expect(screen.getByRole('checkbox')).toHaveAttribute('value', THEME_KEYS.DARK);
  ...
  it('should set light theme attribute when isDarkMode is false', () => {
    ...
    expect(document.documentElement.getAttribute('data-theme')).toBe(THEME_KEYS.LIGHT);
  });
  ...
  it('should set dark theme attribute when isDarkMode is true', () => {
    ...
    expect(document.documentElement.getAttribute('data-theme')).toBe(THEME_KEYS.DARK);
  });
